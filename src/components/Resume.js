...
export default function Resume(){
    return <>
      <section className="pt-10 flex flex-col md:flex-row md:justify-center px-5 sec" id='res'>
        ...
        <div className='w-full md:w-1/2 font-hero-font flex justify-start md:justify-center md:ml-20'>
           <div className='flex flex-col justify-center'>
            <h1 className='text-4xl border-b-2 border-black w-[130px] font-bold'>Resume</h1>
